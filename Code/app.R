...
py_install("numpy")
#py_install("sklearn")
#virtualenv_create(envname = "python_environment",python= "python is /Users/harmeetlamba/opt/anaconda3/bin/python/python.exe")

#use_python("/Users/harmeetlamba/opt/anaconda3/bin/python", required = T) 
...
py_run_string("from sklearn.naive_bayes import GaussianNB, BernoulliNB, MultinomiYalNB")
